...
function renderTodaysTasks(inTaskArr) {
  for (var taskCounter = 0; taskCounter < inTaskArr.length; taskCounter++) {
    ...
    var displayTaskDescription = document.createElement("li");
     var displayTaskDueTime = document.createElement("li");
	  var displayTaskDueDate = document.createElement("li");
    var displayTaskStatus = document.createElement("input");
    displayTaskDescription.textContent = inTaskArr[taskCounter].description;
   displayTaskDueDate.textContent = inTaskArr[taskCounter].date;
	 displayTaskDueTime.textContent = inTaskArr[taskCounter].time;
    ...
    displayTaskBody.appendChild(displayTaskDueDate);			
	 displayTaskBody.appendChild(displayTaskDueTime);
...
function renderAllTasks(inTaskArr) {
  for (var taskCounter = 0; taskCounter < inTaskArr.length; taskCounter++) {
    ...
    var displayTaskDueTime = document.createElement("li");
	  var displayTaskDueDate = document.createElement("li");
	   var displayTaskbreak = document.createElement("br");
    displayTaskDescription.textContent = inTaskArr[taskCounter].description;
    displayTaskDueDate.textContent = inTaskArr[taskCounter].date;
	 displayTaskDueTime.textContent = inTaskArr[taskCounter].time;
    displayTaskBody.appendChild(displayTaskDescription);
    displayTaskBody.appendChild(displayTaskDueDate);			
	 displayTaskBody.appendChild(displayTaskDueTime);
	 displayTaskBody.appendChild(displayTaskbreak);
    displayTask.appendChild(displayTaskBody);
